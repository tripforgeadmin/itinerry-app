...
export const QUESTIONS: Question[] = [
  ...
  // ── S1: Personal Info ─────────────────────────────────────────
  {
    ...
    placeholderEn: "Enter your nickname",
    required: true,
    defaultNextId: "q5",
    section: "S1",
  ...
  // ── S2: Destination + Visa Type ───────────────────────────────
  {
    ...
    sectionEmoji: "✈️",
    // Destination cards keyed by ISO-3166 alpha-2 (lower). Flags at /public/flags/<code>.png.
    // "other" reveals a search-dropdown of every remaining country (CountryScreen).
    options: [
      { value: "jp", label: "ญี่ปุ่น", labelEn: "Japan" },
      { value: "kr", label: "เกาหลีใต้", labelEn: "Korea (South)" },
      { value: "us", label: "สหรัฐอเมริกา", labelEn: "United States" },
      { value: "gb", label: "สหราชอาณาจักร", labelEn: "United Kingdom" },
      { value: "au", label: "ออสเตรเลีย", labelEn: "Australia" },
      { value: "nz", label: "นิวซีแลนด์", labelEn: "New Zealand" },
      { value: "ca", label: "แคนาดา", labelEn: "Canada" },
      { value: "cn", label: "จีน", labelEn: "China" },
      { value: "tw", label: "ไต้หวัน", labelEn: "Taiwan" },
      { value: "in", label: "อินเดีย", labelEn: "India" },
      ...
      { value: "no", label: "นอร์เวย์", labelEn: "Norway" },
      { value: "nl", label: "เนเธอร์แลนด์", labelEn: "Netherlands" },
      { value: "be", label: "เบลเยียม", labelEn: "Belgium" },
      { value: "pt", label: "โปรตุเกส", labelEn: "Portugal" },
      { value: "pl", label: "โปแลนด์", labelEn: "Poland" },
      { value: "fr", label: "ฝรั่งเศส", labelEn: "France" },
      { value: "fi", label: "ฟินแลนด์", labelEn: "Finland" },
      { value: "bt", label: "ภูฏาน", labelEn: "Bhutan" },
      { value: "mt", label: "มอลตา", labelEn: "Malta" },
      { value: "mx", label: "เม็กซิโก", labelEn: "Mexico" },
      { value: "ma", label: "โมร็อกโก", labelEn: "Morocco" },
      { value: "de", label: "เยอรมนี", labelEn: "Germany" },
      { value: "lu", label: "ลักเซมเบิร์ก", labelEn: "Luxembourg" },
      { value: "lt", label: "ลิทัวเนีย", labelEn: "Lithuania" },
      { value: "es", label: "สเปน", labelEn: "Spain" },
      { value: "sk", label: "สโลวาเกีย", labelEn: "Slovakia" },
      { value: "si", label: "สโลวีเนีย", labelEn: "Slovenia" },
      { value: "ch", label: "สวิตเซอร์แลนด์", labelEn: "Switzerland" },
      { value: "se", label: "สวีเดน", labelEn: "Sweden" },
      { value: "at", label: "ออสเตรีย", labelEn: "Austria" },
      { value: "it", label: "อิตาลี", labelEn: "Italy" },
      { value: "eg", label: "อียิปต์", labelEn: "Egypt" },
      { value: "et", label: "เอธิโอเปีย", labelEn: "Ethiopia" },
      { value: "ee", label: "เอสโตเนีย", labelEn: "Estonia" },
      { value: "om", label: "โอมาน", labelEn: "Oman" },
      { value: "is", label: "ไอซ์แลนด์", labelEn: "Iceland" },
      { value: "hu", label: "ฮังการี", labelEn: "Hungary" },
      { value: "other", label: "อื่นๆ", labelEn: "Other country", emoji: "🌍" },
    ],
  },
  {
    id: "q9",
  ...
  // ── S3: Occupation ────────────────────────────────────────────
  {
    ...
    options: [
      ...
      { value: "homemaker", label: "แม่บ้าน / ว่างงาน", labelEn: "Homemaker / Unemployed", emoji: "🏠", nextId: "q29" },
  ...
  // ── S4B: Freelance ────────────────────────────────────────────
  {
    id: "q26",
    type: "multiCheckbox",
    question: "มีเอกสารพิสูจน์รายได้ไหม?",
    questionEn: "Do you have income proof?",
    required: true,
    defaultNextId: "q27",
    section: "S4B",
    ...
    sectionEmoji: "💻",
    options: [
      { value: "contract", label: "สัญญารับจ้าง", labelEn: "Service contract", emoji: "📝" },
      { value: "invoice", label: "ใบแจ้งหนี้ต่อลูกค้า (invoice)", labelEn: "Customer invoice", emoji: "🧾" },
      { value: "bank_transfer", label: "ยอดเงินโอนรายได้ (Bank Transfer)", labelEn: "Income bank transfers", emoji: "🏦" },
      { value: "none", label: "ไม่มีเลย", labelEn: "None", emoji: "➖" },
    ],
  },
  {
  ...
  },
  {
    ...
    id: "q38",
    type: "radio",
    question: "ตอนนี้คุณต้องการให้ช่วยเหลือด้านวีซ่าอย่างไรครับ?",
    ...
    options: [
      ...
      { value: "ready", label: "มีประเทศปลายทาง-วันเดินทางแล้ว / กำลังหาบริการวีซ่าที่เหมาะสม", labelEn: "Destination & dates set / looking for the right visa service" },
